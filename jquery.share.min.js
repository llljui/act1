...
function(r) {
	r.fn.share = function(t) {
        ...
        if (!is_login || !is_identify) {
            l = {
                qzone: "javascript:show_layer();",
				qq: "javascript:show_layer();",
				tencent: "javascript:show_layer();",
				weibo: "javascript:show_layer();",
				wechat: "javascript:;",
				douban: "javascript:show_layer();",
				diandian: "javascript:show_layer();",
				linkedin: "javascript:show_layer();",
				facebook: "javascript:show_layer();",
				twitter: "javascript:show_layer();",
				google: "javascript:show_layer();"
            };
        }
        console.log(6);
